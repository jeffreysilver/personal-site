        ...
        <ul className={styles.socialList}>
          <li>
            <a
              target="_blank"
              rel="noreferrer"
              href="mailto:jeffreysilver@hey.com"
            >
              jeffreysilver@hey.com
            </a>
          </li>
          <li>
            <a
              target="_blank"
              rel="noreferrer"
              href="https://github.com/jeffreysilver/"
            >
              github
            </a>
          </li>
          ...
          <li>
            <a
              target="_blank"
              rel="noreferrer"
              href="https://twitter.com/jeffrey_silver"
            >
              twitter
            </a>
          </li>
          ...
          <li>
            <a
              target="_blank"
              rel="noreferrer"
              href="https://www.linkedin.com/in/jeffrey-silver-96007ab0/"
            >
              linkedin
            </a>
          </li>
